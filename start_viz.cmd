...
rem Server runs in a minimized window titled mempalace-console.
setlocal
cd /d "%~dp0"
set PYTHONUTF8=1
...
start "mempalace-console" /min cmd /c ".venv\Scripts\python.exe -m server.main"
...
echo 停止服务: 关闭最小化的 mempalace-console 窗口
pause
